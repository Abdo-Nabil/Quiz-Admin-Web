...
import 'package:quiz_admin/features/create_quiz/services/create_quiz_reop.dart';
...
import 'features/create_quiz/cubits/create_quiz_cubit.dart';
import 'features/create_quiz/services/create_quiz_local_data.dart';
...
//! Data Sources
//! Core
  //ToDo if you want to use it with mobile or windows ==> uncomment it
...
Future<void> initCreateQuizScreen() async {
  sl.registerFactory(
      () => CreateQuizCubit(createQuizRepo: sl(), generalRepo: sl()));

  sl.registerLazySingleton<CreateQuizRemoteData>(
      () => CreateQuizRemoteData(client: sl()));
  sl.registerLazySingleton<CreateQuizLocalData>(() => CreateQuizLocalData());
  sl.registerLazySingleton<CreateQuizRepo>(
    () => CreateQuizRepo(
      createQuizRemoteData: sl(),
      createQuizLocalData: sl(),
      networkInfo: sl(),
    ),
  );

  //for web only
  sl.registerLazySingleton<NetworkInfo>(() => NetworkInfoWebImpl());
}
//-----------------------------------------------------------------
//
// //! Features - posts
